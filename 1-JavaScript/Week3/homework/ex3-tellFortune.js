...
function selectRandomly(myArray) {
  const randomElement = myArray[Math.floor(Math.random() * 5)];
...
function main() {
  ...
  const partnerNames = ['Nada', 'Wafaa', 'Nour', 'Sulaf', 'Basma'];

  const locations = ['Palestine', 'Netherlands', 'Germany', 'Syria', 'Dubai'];
